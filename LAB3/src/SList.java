...
public class SList {
  ...
  public static void main (String[] args) {
    ...
    SList sltest = new SList();
    sltest.insertEnd(new Integer(6));
    sltest.insertEnd(new Integer(9));
    sltest.insertEnd(new Integer(12));
    System.out.println("The test list should be [6 9 12]: " + sltest.toString());

    sltest.insertFront(new Integer(3));
    sltest.insertEnd(new Integer(15));
    System.out.println("The test list now should be [3 6 9 12 15]: " + sltest.toString());
