...
public class SList {
  ...
  public void squish() {
    ...
    SListNode target = head;
    SListNode currentNode = target.next;
    while (currentNode != null){
      if(target.item.equals(currentNode.item)){
...
//    testAfterInsertEnd();
//    0 0 0 0 1 1 0 0 0 3 3 3 1 1 0
    SList lst = new SList();
    lst.insertEnd(new Integer(0));
    lst.insertEnd(new Integer(0));
    lst.insertEnd(new Integer(0));
    lst.insertEnd(new Integer(0));
    lst.insertEnd(new Integer(1));
    lst.insertEnd(new Integer(1));
    lst.insertEnd(new Integer(0));
    lst.insertEnd(new Integer(0));
    lst.insertEnd(new Integer(0));
    lst.insertEnd(new Integer(3));
    lst.insertEnd(new Integer(3));
    lst.insertEnd(new Integer(3));
    lst.insertEnd(new Integer(1));
    lst.insertEnd(new Integer(1));
    lst.insertEnd(new Integer(0));
    lst.squish();
    System.out.println("The list is: " + lst.toString());
    System.out.println(lst.size);

    SList lst2 = new SList();
    lst2.insertEnd(new Integer(3));
    lst2.insertEnd(new Integer(7));
    lst2.insertEnd(new Integer(4));
    lst2.insertEnd(new Integer(2));
    lst2.insertEnd(new Integer(2));
    lst2.twin();
    System.out.println("The list is: " + lst2.toString());
